...
def main():
    ...
    if args.dataset == 'imagenet':
        ...
        moco_state = torch.load('moco_v2_800ep_pretrain.pth.tar', map_location='cpu', weights_only=False)
    elif args.dataset == 'webvision':
        moco_state = torch.load('moco_pretrained/webvision.tar', map_location='cpu', weights_only=False)
